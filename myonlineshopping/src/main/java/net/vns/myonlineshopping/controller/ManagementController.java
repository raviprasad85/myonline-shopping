...
public class ManagementController {
	...
	public String handleProductActivation(@PathVariable int id) {
		...
		//activate and deactivate the product based on the value of field
		...
		return (isActive)?
				"you have sucessfully deactivate the product with id..."+product.getId()
				:"you have sucessfully activate the product with id..."+product.getId();
