package net.vns.myonlineshopping.validator;
...
public class ProductValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		if(product.getFile()==null) {
			...
			errors.rejectValue("file", null, "Plese select image file to upload!");
			return;
		}
		...
		if(!(
			...
			errors.rejectValue("file", null, "pls use only img file for upload");
			return;
		}
